                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 mb-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button onclick="navigator.clipboard.writeText('${banner.linkUrl}').then(() => alert('✅ Link copiado!')).catch(() => alert('❌ Erro ao copiar'))" 
                                class="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg hover:from-purple-700 hover:to-pink-700 transition flex items-center gap-2 font-semibold">
                                <i class="fas fa-copy"></i>
                                Copiar Link
                            </button>
                        </div>
                        <p class="text-xs text-gray-600 mt-2">
                            <i class="fas fa-info-circle mr-1"></i>
                            Compartilhe este link para que os clientes possam pagar através deste banner
                        </p>
                    </div>
                ` : `
